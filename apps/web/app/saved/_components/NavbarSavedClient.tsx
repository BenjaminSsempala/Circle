...
export default function NavbarSavedClient({ accountMenu }: { accountMenu: React.ReactNode }) {
  ...
  return (
    <nav className="bg-surface border-b border-outline-variant/30 sticky top-0 z-50 w-full">
      ...
      {/* Alternative View Dropdown Tray */}
      {isOpen && (
