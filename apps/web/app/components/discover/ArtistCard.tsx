      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="p-5 flex-1 flex flex-col">
          ...
          <div className="mt-auto flex items-end justify-between gap-2">
            {artist.min_price ? (
              <div>
                <div className="text-[10px] text-outline uppercase font-bold tracking-wider mb-0.5">From</div>
                <div className="text-primary font-mono text-[15px] leading-none">
                  {artist.currency ?? 'UGX'} {artist.min_price.toLocaleString()}
                </div>
              </div>
            ) : (
            ...
            {inviteMode ? (
              <span
                ...
                className={`flex-shrink-0 px-4 py-2 rounded-full text-[11px] font-bold border transition-colors cursor-pointer ${
                  invited
